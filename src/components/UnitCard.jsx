...
export default function UnitCard({ unit, type }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-[13%] flex flex-col items-center px-2 text-center">
        <span className="font-display text-base font-bold text-white drop-shadow-lg sm:text-xl">{unit.name}</span>
        {isOccupied && unit.assignedEmployeeName && (
          <span className="mt-0.5 text-xs font-medium text-gold-300 drop-shadow-lg sm:text-sm">
